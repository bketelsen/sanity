...
<main class="container max-w-3xl mx-auto xl:max-w-5xl px-4 xl:px-0">
	<article class="relative flex flex-col md:px-4 xl:grid xl:grid-cols-4 xl:col-gap-6">
		<div class="pb-4 md:mr-8 xl:pb-0 xl:mb-8 xl:col-span-3 mt-4 xl:mt-10">
			<h2 class="text-3xl xl:text-4xl font-bold mb-4 text-white leading-snug xl:leading-snug">
				{tech.title}
			</h2>
		</div>
		<div
		...
		>
			...
			<div class="pb-4 md:mr-8 xl:pb-0 xl:mb-8 xl:col-span-3 mt-4 xl:mt-10">
				<h3 class="text-xl xl:text-2xl font-bold mb-4 text-white leading-snug xl:leading-snug">
        ...
        <div>
          ...
          <a href={reference.link} class="ml-4 block font-medium leading-5  hover:text-indigo-300 focus:outline-none  transition duration-150 ease-in-out">
            {reference.title}
            </a>
           </p>
          {/each}
        ...
        <div>
          ...
          <a href={article.link} class="ml-4 block font-medium leading-5  hover:text-indigo-300 focus:outline-none  transition duration-150 ease-in-out">
            {article.title}
            </a>
           </p>
          {/each}
